# C# at Energise Style Guide

This style guide is for C# code developed internally at Energise, and is the default style for C# code at Energise. It makes stylistic choices that conform to other languages at Energise. This style guide is forked from Google's C# style guide which can be found [here](https://google.github.io/styleguide/csharp-style.html)
